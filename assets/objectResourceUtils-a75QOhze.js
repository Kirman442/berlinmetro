...
}`);break;default:rt(e.doubleSidedMode);case oe.COUNT:}}var oe;(function(t){t[t.None=0]="None",t[t.View=1]="View",t[t.WindingOrder=2]="WindingOrder",t[t.COUNT=3]="COUNT"})(oe||(oe={}));var ee;function Ze(t,e){switch(e.textureCoordinateType){case ee.Default:return t.attributes.add(f.UV0,"vec2"),t.varyings.add("vuv0","vec2"),void t.vertex.code.add(s`void forwardTextureCoordinates() {
vuv0 = uv0;
}`);case ee.Compressed:return t.attributes.add(f.UV0,"vec2"),t.varyings.add("vuv0","vec2"),void t.vertex.code.add(s`vec2 getUV0() {
return uv0 / 16384.0;
}
void forwardTextureCoordinates() {
vuv0 = getUV0();
}`);case ee.Atlas:return t.attributes.add(f.UV0,"vec2"),t.varyings.add("vuv0","vec2"),t.attributes.add(f.UVREGION,"vec4"),t.varyings.add("vuvRegion","vec4"),void t.vertex.code.add(s`void forwardTextureCoordinates() {
vuv0 = uv0;
vuvRegion = uvRegion;
...
return occlusion;
}`)):r.code.add(s`float getBakedOcclusion() { return 1.0; }`),i===$.Pass?r.uniforms.add(new Z("emissionFactor",a=>a.emissiveFactor),new Z("mrrFactors",a=>a.mrrFactors)):r.uniforms.add(new pe("emissionFactor",a=>a.emissiveFactor),new pe("mrrFactors",a=>a.mrrFactors)),r.code.add(s`
...
return posClip;
}`)}function Ue(t,e){Hs(t,e,new pe("slicePlaneOrigin",(r,o)=>js(e,r,o)),new pe("slicePlaneBasis1",(r,o)=>{var i;return fo(e,r,o,(i=o.slicePlane)==null?void 0:i.basis1)}),new pe("slicePlaneBasis2",(r,o)=>{var i;return fo(e,r,o,(i=o.slicePlane)==null?void 0:i.basis2)}))}function Hs(t,e,...r){if(!e.hasSlicePlane){const n=s`#define rejectBySlice(_pos_) false
...
return mix(color, vec4(HIGHLIGHT_COLOR.rgb, color.a), highlightFactor * HIGHLIGHT_COLOR.a);
      ...
      `:s`#define highlightSlice(_color_, _pos_) (_color_)`;e.hasSliceInVertexProgram&&t.vertex.code.add(o),t.fragment.code.add(o),t.fragment.code.add(a)}function fa(t,e,r){return t.instancedDoublePrecision?U(Ws,r.camera.viewInverseTransposeMatrix[3],r.camera.viewInverseTransposeMatrix[7],r.camera.viewInverseTransposeMatrix[11]):e.slicePlaneLocalOrigin}function pa(t,e){return t!=null?Ye(jt,e.origin,t):e.origin}function va(t,e,r){return t.hasSliceTranslatedView?e!=null?vr(ks,r.camera.viewMatrix,e):r.camera.viewMatrix:null}function js(t,e,r){if(r.slicePlane==null)return Yt;const o=fa(t,e,r),i=pa(o,r.slicePlane),a=va(t,o,r);return a!=null?Oe(jt,i,a):i}function fo(t,e,r,o){if(o==null||r.slicePlane==null)return Yt;const i=fa(t,e,r),a=pa(i,r.slicePlane),n=va(t,i,r);return n!=null?(xe(lt,o,a),Oe(jt,a,n),Oe(lt,lt,n),Ye(lt,lt,jt)):o}const Ws=P(),jt=P(),lt=P(),ks=Zt();function xt(t){ua(t),t.vertex.code.add(s`vec4 transformPositionWithDepth(mat4 proj, mat4 view, vec3 pos, vec2 nearFar, out float depth) {
vec4 eye = view * vec4(pos, 1.0);
depth = calculateLinearDepth(nearFar,eye.z);
return proj * eye;
}`),t.vertex.code.add(s`vec4 transformPosition(mat4 proj, mat4 view, vec3 pos) {
return proj * (view * vec4(pos, 1.0));
}`)}let te=class extends Q{constructor(e,r){super(e,"float",$.Pass,(o,i,a)=>o.setUniform1f(e,r(i,a)))}},qs=class extends Q{constructor(e,r){super(e,"mat4",$.Draw,(o,i,a)=>o.setUniformMatrix4fv(e,r(i,a)))}};function bt(t,e){e.instancedDoublePrecision?t.constants.add("cameraPosition","vec3",Yt):t.uniforms.add(new pe("cameraPosition",(r,o)=>U(ga,o.camera.viewInverseTransposeMatrix[3]-r.origin[0],o.camera.viewInverseTransposeMatrix[7]-r.origin[1],o.camera.viewInverseTransposeMatrix[11]-r.origin[2])))}function Tt(t,e){if(!e.instancedDoublePrecision)return void t.uniforms.add(new Ke("proj",(o,i)=>i.camera.projectionMatrix),new qs("view",(o,i)=>vr(po,i.camera.viewMatrix,o.origin)),new pe("localOrigin",o=>o.origin));const r=o=>U(ga,o.camera.viewInverseTransposeMatrix[3],o.camera.viewInverseTransposeMatrix[7],o.camera.viewInverseTransposeMatrix[11]);t.uniforms.add(new Ke("proj",(o,i)=>i.camera.projectionMatrix),new Ke("view",(o,i)=>vr(po,i.camera.viewMatrix,r(i))),new Z("localOrigin",(o,i)=>r(i)))}const po=Zt(),ga=P();function Xs(t){t.uniforms.add(new Ke("viewNormal",(e,r)=>r.camera.viewInverseTransposeMatrix))}let Ys=class extends Ct{constructor(){super(),this._key="",this._keyDirty=!1,this._parameterBits=this._parameterBits?this._parameterBits.map(()=>0):[],this._parameterNames||(this._parameterNames=[])}get key(){return this._keyDirty&&(this._keyDirty=!1,this._key=String.fromCharCode.apply(String,this._parameterBits)),this._key}snapshot(){const e=this._parameterNames,r={key:this.key};for(const o of e)r[o]=this[o];return r}};function g(t={}){return(e,r)=>{if(e._parameterNames=e._parameterNames??[],e._parameterNames.push(r),t.constValue!=null)Object.defineProperty(e,r,{get:()=>t.constValue});else{const o=e._parameterNames.length-1,i=t.count||2,a=Math.ceil(Math.log2(i)),n=e._parameterBits??[0];let l=0;for(;n[l]+a>16;)l++,l>=n.length&&n.push(0);e._parameterBits=n;const c=n[l],u=(1<<a)-1<<c;n[l]+=a,Object.defineProperty(e,r,{get(){return this[o]},set(d){if(this[o]!==d&&(this[o]=d,this._keyDirty=!0,this._parameterBits[l]=this._parameterBits[l]&~u|+d<<c&u,typeof d!="number"&&typeof d!="boolean"))throw new Error("Configuration value for "+r+" must be boolean or number, got "+typeof d)}})}}}let Sr=class extends Ys{constructor(){super(...arguments),this.instancedDoublePrecision=!1,this.hasModelTransformation=!1}};m([g()],Sr.prototype,"instancedDoublePrecision",void 0),m([g()],Sr.prototype,"hasModelTransformation",void 0);const vo=Jt();function xa(t,e){const r=e.hasModelTransformation,o=e.instancedDoublePrecision;r&&(t.vertex.uniforms.add(new Ke("model",a=>a.modelTransformation??Ut)),t.vertex.uniforms.add(new Me("normalLocalOriginFromModel",a=>(gr(vo,a.modelTransformation??Ut),vo)))),e.instanced&&o&&(t.attributes.add(f.INSTANCEMODELORIGINHI,"vec3"),t.attributes.add(f.INSTANCEMODELORIGINLO,"vec3"),t.attributes.add(f.INSTANCEMODEL,"mat3"),t.attributes.add(f.INSTANCEMODELNORMAL,"mat3"));const i=t.vertex;o&&(i.include(ia,e),i.uniforms.add(new pe("viewOriginHi",(a,n)=>un(U(It,n.camera.viewInverseTransposeMatrix[3],n.camera.viewInverseTransposeMatrix[7],n.camera.viewInverseTransposeMatrix[11]),It)),new pe("viewOriginLo",(a,n)=>hn(U(It,n.camera.viewInverseTransposeMatrix[3],n.camera.viewInverseTransposeMatrix[7],n.camera.viewInverseTransposeMatrix[11]),It)))),i.code.add(s`
  ...
  `)}let Ta=class extends Q{constructor(e,r){super(e,"int",$.Pass,(o,i,a)=>o.setUniform1i(e,r(i,a)))}};function _a(t,e){e.hasSymbolColors?(t.include(Js),t.attributes.add(f.SYMBOLCOLOR,"vec4"),t.varyings.add("colorMixMode","mediump float"),t.vertex.code.add(s`int symbolColorMixMode;
vec4 getSymbolColor() {
return decodeSymbolColor(symbolColor, symbolColorMixMode) * 0.003921568627451;
}
void forwardColorMixMode() {
colorMixMode = float(symbolColorMixMode) + 0.5;
}`)):(t.fragment.uniforms.add(new Ta("colorMixMode",r=>ps[r.colorMixMode])),t.vertex.code.add(s`vec4 getSymbolColor() { return vec4(1.0); }
void forwardColorMixMode() {}`))}function ba(t,e){e.hasVertexColors?(t.attributes.add(f.COLOR,"vec4"),t.varyings.add("vColor","vec4"),t.vertex.code.add(s`void forwardVertexColor() { vColor = color; }`),t.vertex.code.add(s`void forwardNormalizedVertexColor() { vColor = color * 0.003921568627451; }`)):t.vertex.code.add(s`void forwardVertexColor() {}
...
forwardTextureCoordinates();
        ...
        `)}}function hl(t,e){const r=t.fragment;e.hasVertexTangents?(t.attributes.add(f.TANGENT,"vec4"),t.varyings.add("vTangent","vec4"),e.doubleSidedMode===oe.WindingOrder?r.code.add(s`mat3 computeTangentSpace(vec3 normal) {
